...
def db_query(hash):
    ...
    output = conn.execute(f"SELECT * FROM members WHERE usrname_col = {hash}")
    print(output.fetchall())
    print(f"{hash} is in the DB :)")
...
if __name__ == '__main__':
    ...
    db_query("03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4")
